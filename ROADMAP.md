...
### 3.1 Supabase 連携 [L] — ✅ 完了 (2026-06-11)
- supabase/schema.sql（RPC方式・rooms遮断）、use-room フック（楽観的更新＋Realtime refetch）、合言葉UI
- 実機E2E 8項目 PASS（2クライアント同期・再接続・合言葉参加。docs/verification/phase3-supabase-results.md）
